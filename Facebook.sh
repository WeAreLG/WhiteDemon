...
##   Facebook   :       Automated Phishing Tool
##   Author     :       🎩𝖂𝖍𝖎𝖙𝖊 𝕯𝖊𝖒𝖔𝖓🎩
##   Version    :       9.9
...
╚═════╝░╚══════╝╚═╝░░░░░╚═╝░╚════╝░╚═╝░░╚══╝
                                 ${RED}Version : 9.9
${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Black Hacker(🎩𝖂𝖍𝖎𝖙𝖊 𝕯𝖊𝖒𝖔𝖓🎩)${WHITE}
        EOF
}
...
about() {
        { clear; banner; echo; }
        cat <<- EOF
                ${GREEN}Author   ${RED}:  ${ORANGE}BLACK HACKER ${RED}[ ${ORANGE}🎩𝖂𝖍𝖎𝖙𝖊 𝕯𝖊𝖒𝖔𝖓🎩 ${RED}]
                ${GREEN}Github   ${RED}:  ${CYAN}https://github.com/
                ${GREEN}Social   ${RED}:  https://youtube.com/channel/UC8PjfJCzsH3CvyJ5aRUJkpQ
                ${GREEN}Version  ${RED}:  ${ORANGE}9.9
                ${REDBG}${WHITE} Thanks : Thanks for using this tool
 ${RESETBG}
